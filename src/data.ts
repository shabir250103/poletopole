...
export const IMAGE_MAP: Record<string, string> = {
  // AFRICA
  'Kenya': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939014/Kenya_eidxlh.jpg',
  ...
  'South Africa': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939017/South_Africa_ckhxqi.jpg',
  'Zimbabwe': 'https://images.unsplash.com/photo-1603204006132-7bb3b7bca06e?auto=format&fit=crop&w=800&q=80',
  'Tanzania': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939017/Tanzania_fo51it.jpg',
  ...
  'Cambodia': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939008/Cambodia_wec4yo.jpg',
  'China': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939009/china_kjifkn.jpg',
  'Hong Kong': 'https://images.unsplash.com/photo-1506157786151-b8491531f063?auto=format&fit=crop&w=800&q=80',
  'Japan': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939014/japan_spebph.jpg',
  'Indonesia': 'https://images.unsplash.com/photo-1537953773315-2213cd4609c0?auto=format&fit=crop&w=800&q=80',
  'Kazakhstan': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939014/Kazakhstan_icp73s.jpg',
  ...
  'Thailand': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939017/thailand_kk7jix.jpg',
  'Vietnam': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939018/vietnam_ubgp1i.jpg',
  'Uzbekistan': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939018/Uzbekistan_lyepcq.jpg',

  // EUROPE
  'Armenia': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939009/Armenia_oav1ak.jpg',
  ...
  'France': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939010/france_gq3w3r.jpg',
  'Germany': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939011/germany_i5nbyb.jpg',
  'Georgia': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939010/Georgia_gxf2z1.jpg',
  ...
  'London': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779940972/london_b4jsjo.jpg',
  ...
  'Switzerland': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779940933/8544f971001e0e1db0da455d66fbe491_1_ngwwda.jpg',
  'Turkey': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939017/turkey_hphcuq.jpg',
  ...
  'Mauritius': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779940933/b09f9bdc43661c4140e89e36125b66a2_rajuuq.jpg',
  ...
  'Oman': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939016/oman_real_zsi82t.jpg',
  ...
  'Egypt': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939009/egypt_bjoxzm.jpg',
  ...
  'Delhi': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939009/delhi_qjwtgf.jpg',
  ...
  'Jaipur': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939013/jaipur_d8z0am.jpg',
  ...
  'Ladakh': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939014/ladakh-trek-e1635267234139_bxnlqx.jpg',
  ...
  'Rajasthan': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939016/rajasthan_zonntu.jpg',
  ...
  'Coorg': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939009/coorg_rqavlt.jpg',
  'Hyderabad': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939013/hydrabad_cvvcrt.jpg',
  'Hydrabad': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939013/hydrabad_cvvcrt.jpg',
  ...
  'Mysore': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939016/mysore_dsp3op.jpg',
  ...
  'Lakshadweep': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939015/lakshadweep_dftang.jpg',
  ...
  'Kolkata': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939014/Kolkata_ctyphp.jpg',
  ...
  'Pune': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939017/pune_vvbxer.jpg',
  ...
  'Meghalaya': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939015/Meghalaya_scmnay.jpg',
  ...
  'North East': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939015/North_East_India_vfjoqy.jpg',
  'North East India': 'https://res.cloudinary.com/dnmsztoba/image/upload/q_auto/f_auto/v1779939015/North_East_India_vfjoqy.jpg',
...
const RAW_INTERNATIONAL_CATALOG = [
  // Asia
  { name: 'Dubai', tags: ['Asia', 'Honeymoon Packages'] },
  { name: 'Singapore', tags: ['Asia'] },
  { name: 'Malaysia', tags: ['Asia'] },
  { name: 'Bali', tags: ['Asia', 'Honeymoon Packages'] },
  { name: 'Vietnam', tags: ['Asia'] },
  { name: 'Cambodia', tags: ['Asia'] },
  { name: 'Sri Lanka', tags: ['Asia', 'Honeymoon Packages'] },
  { name: 'Maldives', tags: ['Asia', 'Honeymoon Packages'] },
  { name: 'Hong Kong', tags: ['Asia'] },
  { name: 'China', tags: ['Asia'] },
  { name: 'Japan', tags: ['Asia'] },
  { name: 'Thailand', tags: ['Asia', 'Honeymoon Packages'] },
  ...
  // Europe
  { name: 'Turkey', tags: ['Europe', 'Honeymoon Packages'] },
  { name: 'Armenia', tags: ['Europe'] },
  { name: 'Georgia', tags: ['Europe'] },
  { name: 'Greece', tags: ['Europe', 'Honeymoon Packages'] },
  { name: 'France', tags: ['Europe'] },
  { name: 'Germany', tags: ['Europe'] },
  { name: 'London', tags: ['Europe'] },
  { name: 'Switzerland', tags: ['Europe', 'Honeymoon Packages'] },

  // Africa
  { name: 'Egypt', tags: ['Africa'] },
  { name: 'Mauritius', tags: ['Africa', 'Honeymoon Packages'] },
  { name: 'Kenya', tags: ['Africa'] },
  { name: 'South Africa', tags: ['Africa'] },
  { name: 'Tanzania', tags: ['Africa'] }
];

const RAW_DOMESTIC_CATALOG = [
  // North India Packages
  { name: 'Kashmir', tags: ['North India Packages', 'Honeymoon Packages'] },
  { name: 'Delhi', tags: ['North India Packages', 'Educational & Heritage Packages'] },
  { name: 'Agra', tags: ['North India Packages', 'Educational & Heritage Packages'] },
  { name: 'Jaipur', tags: ['North India Packages', 'Educational & Heritage Packages'] },
  { name: 'Himachal Pradesh', tags: ['North India Packages', 'Honeymoon Packages'] },
  { name: 'Rajasthan', tags: ['North India Packages', 'Educational & Heritage Packages'] },

  // South India Packages
  { name: 'Bangalore', tags: ['South India Packages'] },
  { name: 'Mysore', tags: ['South India Packages', 'Educational & Heritage Packages'] },
  { name: 'Ooty', tags: ['South India Packages', 'Honeymoon Packages'] },
  { name: 'Kodaikanal', tags: ['South India Packages', 'Honeymoon Packages'] },
  { name: 'Kerala', tags: ['South India Packages', 'Honeymoon Packages'] },
  { name: 'Hyderabad', tags: ['South India Packages', 'Educational & Heritage Packages'] },
  { name: 'Coorg', tags: ['South India Packages', 'Honeymoon Packages'] },
  { name: 'Andaman', tags: ['South India Packages', 'Honeymoon Packages'] },
  { name: 'Lakshadweep', tags: ['South India Packages', 'Honeymoon Packages'] },

  // West India Packages
  { name: 'Goa', tags: ['West India Packages', 'Honeymoon Packages'] },
  { name: 'Mumbai', tags: ['West India Packages'] },
  { name: 'Pune', tags: ['West India Packages'] },

  // East India Packages
  { name: 'Kolkata', tags: ['East India Packages', 'Educational & Heritage Packages'] },

  // North East India Packages
  { name: 'Meghalaya', tags: ['North East India Packages', 'Honeymoon Packages'] },
  { name: 'North East India', tags: ['North East India Packages'] }
];
